        ...
        <>
            <FooterContainer>
                ...
                <FooterInnerContainer>
                    ...
                    <p>Tellerpoint is a product of Branchless Innovation Limited, <Br/>a company duly registered with the Corporate Affairs <Br/>Commission in Nigeria. We are on a mission to enabling <Br/>economic prosperity for Africans through universal and<Br/> inclusive commerce.</p>
                </FooterInnerContainer>
            </FooterContainer>
        </>
    )
